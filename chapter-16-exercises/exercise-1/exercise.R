...
diamonds_sample <- sample_n(diamonds, 1000) # Randomly take 1000 numbers

# Start by making a new `ggplot` with the `diamonds_sample` as the data (no 
# geometry yet)
# What do you see? (What did you expect?)
ggplot(data = diamonds_sample) # A blank canvas
...
# As the carat is getting bigger, the price goes up
